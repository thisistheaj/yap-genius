...
INSERT INTO "new_Message" ("channelId", "content", "createdAt", "deletedAt", "editedAt", "id", "parentId", "systemData", "updatedAt", "userId") SELECT "channelId", "content", "createdAt", "deletedAt", "editedAt", "id", "parentId", "systemData", "updatedAt", "userId" FROM "Message";
DROP TABLE "Message";
